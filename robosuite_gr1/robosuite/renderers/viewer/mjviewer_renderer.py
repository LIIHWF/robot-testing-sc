        ...
        if self.viewer is None:
            ...
            if self.camera_id is not None:
                if self.camera_id >= 0:
                    ...
                    # camera_name = self.env.sim.model.camera_id2name(self.camera_id)
                    # print(f"Camera ID {self.camera_id} corresponds to: {camera_name}")
                    # input("Press Enter to continue... (case 2)")
